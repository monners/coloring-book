    ...
    render() {
        return (
            <div className='bird-wrapper'>
                <svg width="500px" height="500px" viewBox="0 0 500 500" enable-background="new 0 0 500 500">
                    <g>
                    	<path id="tail" fill={`#${this.props.tail}`} d="M297.088,268.726c4.408-0.802,119.323-56.945,136.103-44.069
                    	...
                    	<g id="legs">
                    		<g>
                    			<path fill={`#${this.props.legs}`} d="M183.708,469.419c-0.723,0-1.457-0.181-2.138-0.555c-2.143-1.176-2.921-3.878-1.74-6.018l12.59-22.855
                                ...
                                <path fill={`#${this.props.legs}`} d="M164.779,463.108c-1.568,0-3.088-0.837-3.896-2.313c-1.17-2.146-0.381-4.841,1.77-6.011l32.043-17.48
                    		...
                    		<g>
                    			<path fill={`#${this.props.legs}`} d="M273.443,474.759c-0.502,0-1.013-0.082-1.511-0.27c-2.301-0.832-3.489-3.375-2.654-5.674l9.439-26.062
                                ...
                                <path fill={`#${this.props.legs}`} d="M251.236,465.097c-1.57,0-3.09-0.837-3.897-2.313c-1.169-2.146-0.381-4.841,1.771-6.011l32.042-17.48
                    	...
                    	<path id="body" fill={`#${this.props.body}`} d="M338.238,212.412c0,67.201-7.021,121.674-100.622,121.674
                    	...
                    	<g id="beak">
                    		<polygon id="beak_x5F_upper" fill={`#${this.props.beakUpper}`} points="143.318,167.185 8.568,236.928 201.24,233.383 		"/>
                    		<polygon id="beak_x5F_lower" fill={`#${this.props.beakLower}`} points="201.24,233.383 144.503,273.893 8.568,236.928 		"/>
                    	</g>
                    	<g id="eye">
                    		...
                    		<g>
                    			<path fill={`#${this.props.eye}`} d="M235.341,167.185c0,12.564-10.181,22.746-22.741,22.746c-12.557,0-22.741-10.181-22.741-22.746
                    	...
                    	<path id="wing" fill={`#${this.props.wing}`} d="M302.062,227.69c-77.775-21.034-89.124,1.677-80.865,57.228
                    	...
                    	<g id="hair">
                    		<path fill={`#${this.props.hair}`} d="M264.849,109.068c21.251-55.102-15.619-83.66-15.619-83.66s24.396,51.442,0.783,81
                    			C264.849,109.068,264.849,109.068,264.849,109.068z"/>
                            <path fill={`#${this.props.hair}`} d="M253.479,105.073c6.449-58.711-36.498-76.884-36.498-76.884s36.742,43.482,21.469,78.109
                    			C253.479,105.073,253.479,105.073,253.479,105.073z"/>
                            <path fill={`#${this.props.hair}`} d="M254.271,113.128c-13.722-57.462-60.287-60.091-60.287-60.091s49.257,28.556,46.551,66.31
                    			C254.271,113.128,254.271,113.128,254.271,113.128z"/>
                            <path fill={`#${this.props.hair}`} d="M231.767,115.989c-9.786-40.975-42.996-42.851-42.996-42.851s35.127,20.37,33.196,47.29
